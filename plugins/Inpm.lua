...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to MoBot!\n\nTo get a list of MoBot groups use /chats or /chatlist for a document list of chats.\n\nTo get a new MoBot group, contact a support group:\n\nFor Join support, use: /join support\n\nFor more information, check out our channels:\n\n@MoBotChannel [Persian]\n\nThanks for using @MoBot!"
     	return text
    end
